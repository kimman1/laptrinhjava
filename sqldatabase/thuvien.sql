...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Nov 12, 2019 at 05:34 AM
...
(4, 'Hằng', '0123456789', '371 nguyễn kiệm ', 'hang', 'hang123'),
(5, 'Mãn', '0985855746', '93 đường số 5', 'kimman3', 'kimman');
...
(1, 'quangdeptrai', 'quang123', 'Quảng', '1234567890', 'Đang Làm', '10/10/1992'),
(2, 'quandeptrai', 'quan123', 'Quân', '0123456789', 'Đang Làm', '12/10/1997'),
(3, 'as', 'as', 'as', '01', 'Đã Nghỉ', '12/10/1982');
...
(2, 1, 3, 2, '2019-09-23', '2019-10-26', '2019-10-26', 2, '50000', '10', b'1'),
(20, 3, 1, 1, '2019-10-15', '2019-10-22', '2019-10-23', 6, '', NULL, b'0'),
(22, 2, 12, 1, '2019-10-17', '2019-10-22', '2019-10-23', 2, '', NULL, b'0'),
(25, 4, 14, 2, '2019-11-07', '2019-11-07', '2019-11-09', 5, NULL, NULL, b'0'),
(27, 4, 15, 2, '2019-11-08', '2019-11-09', '2019-11-16', 2, NULL, NULL, b'0'),
(28, 3, 13, 2, '2019-11-08', '2019-11-09', '2019-11-15', 2, NULL, NULL, b'0'),
(30, 3, 2, 1, '2019-11-08', '2019-11-15', '2019-11-22', 2, NULL, NULL, b'0'),
(31, 4, 15, 2, '2019-11-08', '2019-11-08', '2019-11-10', 1, NULL, NULL, b'0');
...
(2, 'Lập Trình Java', 'Dương Hữu Thành', '371 Nguyễn Kiệm', 18, '70'),
(3, 'Lập Trình Mạng', 'Lưu Quang Phương', '371 Nguyễn Kiệm', 8, '12'),
(4, 'Quản Trị Hệ CSDL', 'Hồ Quang Khải', '371 Nguyễn Kiệm', 10, '60'),
(12, 'Quản Trị Mạng', 'Lưu Quang Phương', '371 Nguyễn Kiệm', 98, '200'),
(13, 'Kiến Trúc Máy Tính', 'Tô Oai Hùng', '371 Nguyễn Kiệm', 98, '300'),
(14, 'Xử Lý Ảnh', 'Lê Viết Tuấn', '371 Nguyễn Kiệm', 85, '400'),
(15, 'Xử Lý Ảnh', 'Lê Công Vinh', '371 Nguyễn Kiệm', 27, '50');
